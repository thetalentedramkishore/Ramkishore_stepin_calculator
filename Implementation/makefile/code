# Name of the project
PROJ_NAME = Scientific_Calculator
...
SRC =src/add.c\
src/sub.c\
src/multiply.c src/division.c src/factorial.c src/logarithm.c src/power.c src/squareroot.c\
src/sine.c src/cosine.c src/tangent.c src/cotangent.c src/secant.c\
src/cosecant.c
